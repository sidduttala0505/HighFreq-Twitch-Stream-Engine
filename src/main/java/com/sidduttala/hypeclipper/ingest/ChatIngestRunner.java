...
/**
 * Kicks off the chat connection once the context is up. Everything past this
 * point happens on the consumer side.
 */
@Component
public class ChatIngestRunner implements ApplicationRunner {
    ...
    public ChatIngestRunner(TwitchIrcClient irc, ChatEventProducer producer, HypeProperties props) {
        this.irc = irc;
